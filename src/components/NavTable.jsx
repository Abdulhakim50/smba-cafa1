...
const NavTable = ({ data, selectedRow, setSelectedRow, isOpen, isOpenPrice, selectedData, activeAdisyon }) => {
  return (
    <>
      ...
      <div className={`  max-w-[300px]     border transition-[30s] ${isOpen && 'hidden transition-[30s] '}   `}>
        <h1 className='text-center pt-16 pb-3  font-semibold'>{isOpenPrice && 'PRODUCTS' || activeAdisyon && 'Active Adision' || 'REPORTS'}</h1>
        {
